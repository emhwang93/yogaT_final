...
public class OKHttpConnection {
    ...
    public void sendToServer_Top3(Callback callback,JSONObject json){
        ...
        request = new Request.Builder()
                .url("http://255.255.255.0:8000/yogat/sendImageToAndroid_top3")
                .post(body)
                .build();
    ...
    public void sendToServer_main(JSONObject json){
        Callback OKHttpCallback = new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Log.d("eunmi", "Error Message : " + e.getMessage());
            }

            @Override
            public void onResponse(Call call, Response response) throws IOException {
                responseData = response.body().string();
                Log.d("eunmi", "responseData in OkhttpConnection : " + responseData);
            }
        };
        ...
        request = new Request.Builder()
                .url("http://255.255.255.0:8000/yogat/main")
                .post(body)
                .build();
    ...
    public void sendToServer_singlePose(String imageString){
        ...
        request = new Request.Builder()
                .url("http://255.255.255.0:8000/yogat/singlePose")
                .post(body)
                .build();
        client.newCall(request).enqueue(OKHttpCallback);
    }
    ...
    public void sendToServer_freemode(String imageString){
        Callback OKHttpCallback = new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.d("eunmi", "score_list is : " + score_list.get(0));
                Log.d("eunmi", "responseData in OkhttpConnection : " + responseData);
            }
        };
        body = new FormBody.Builder()
                .add("image", imageString).build();
        request = new Request.Builder()
                .url("http://255.255.255.0:8000/yogat/freemode")
                .post(body)
                .build();
        client.newCall(request).enqueue(OKHttpCallback);
    }
    ...
    public void sendToServer_BandA(Callback callback,JSONObject json){
        ...
        request = new Request.Builder()
                .url("http://255.255.255.0:8000/yogat/sendImageToAndroid_BandA")
                .post(body)
                .build();
        client.newCall(request).enqueue(callback);
    }
    ...
    public void sendToServer_Login(Callback callback,JSONObject jObject){
        ...
        request = new Request.Builder()
                .url("http://255.255.255.0:8000/yogat/user_login")
                .post(body)
                .build();
        client.newCall(request).enqueue(callback);
    }
    ...
    public void sendToServer_Register(JSONObject jObject){
        ...
        request = new Request.Builder()
                .url("http://255.255.255.0:8000/yogat/user_signup")
                .post(body)
                .build();
        client.newCall(request).enqueue(OKHttpCallback);
