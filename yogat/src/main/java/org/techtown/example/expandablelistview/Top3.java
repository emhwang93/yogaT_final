        ...
        public void handleMessage(Message msg) {
            ...
            if (requestDate != null) {
                ...
                if (imageList != null) {
                    ...
                    Log.d("eunmi", "thread check");
                } else {
                    Glide.with(Top3.this)
                            .asGif()                              //GIF 로딩
                            .load(R.raw.loading3)                //Image url
                            .placeholder(R.drawable.loading3)    //animated progress bar
                            .diskCacheStrategy(DiskCacheStrategy.NONE)   //Don't store cache    //RESOURCE 으로 바꿨을때 Glide에서 캐싱한 리소스와 로드할 리소스가 같을때 캐싱된 리소스 사용
                            .into(loading);
